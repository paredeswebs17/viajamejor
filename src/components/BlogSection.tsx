                ...
                <div className="relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  <div className="relative h-56 sm:h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                      <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-sky-200 transition-colors">
                        {article.title}
                      </h3>
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {article.savings && (
                          <div className="flex items-center bg-emerald-500/90 backdrop-blur-sm rounded-full px-3 py-1">
                            <TrendingUp className="h-3 w-3 text-white mr-1" />
                            <span className="text-xs text-white font-medium">{article.savings}</span>
                          </div>
                        )}
                      </div>
                    </div>
