...
const RomaGuideArticle: React.FC<RomaGuideArticleProps> = ({ onBack }) => {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-24">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-all duration-300 mb-8">
        ...
        <div className="mb-8">
          <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
            ...
            🏨 Dónde Alojarse - Mejores Zonas de Roma
          </h3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              <h4 className="text-lg font-bold text-red-800 mb-3">🏛️ Centro Histórico</h4>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-3 shadow-sm">
                  <h5 className="font-semibold text-gray-900 mb-1">Hotel Smeraldo</h5>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm">
                  <h5 className="font-semibold text-gray-900 mb-1">Terrace Pantheon Relais</h5>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
              <h4 className="text-lg font-bold text-purple-800 mb-3">⛪ Vaticano / Prati</h4>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-3 shadow-sm">
                  <h5 className="font-semibold text-gray-900 mb-1">Donna Laura Palace</h5>
                ...
                <div className="bg-white rounded-lg p-3 shadow-sm">
                  <h5 className="font-semibold text-gray-900 mb-1">Hotel Isa</h5>
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
            <h4 className="text-lg font-bold text-green-800 mb-3">🌿 Trastevere - Bohemio y con Encanto</h4>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
            <h5 className="font-semibold text-yellow-800 mb-2">💡 Consejos sobre Alojamiento:</h5>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-700">
                <div>
                  ...
                  <p className="mb-2"><strong>Bono 72 horas:</strong> 18€ (perfecto para 3 días)</p>
                </div>
                <div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-4">
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
              <h4 className="font-bold text-gray-900 mb-3">Roma Pass</h4>
              <p className="text-sm text-gray-700 mb-3">
                <strong>48 horas:</strong> 32€ | <strong>72 horas:</strong> 52€
              </p>
              <p className="text-sm font-semibold text-gray-900 mb-2">Incluye:</p>
              <ul className="text-sm text-gray-700 space-y-1 mb-3">
                <li>• 1 entrada gratis (48h) o 2 entradas gratis (72h)</li>
                <li>• Descuentos en otras atracciones</li>
                <li>• Transporte público ilimitado</li>
                <li>• Acceso prioritario en algunos sitios</li>
              </ul>
              <p className="text-xs text-yellow-700 bg-yellow-100 rounded p-2">
                <strong>Veredicto:</strong> NO suele compensar. Es mejor comprar entradas sueltas + bono transporte por separado.
              </p>
            </div>
            
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
              <h4 className="font-bold text-gray-900 mb-3">Omnia Vatican Card</h4>
              <p className="text-sm text-gray-700 mb-3">
                <strong>72 horas:</strong> 149€
              </p>
              <p className="text-sm font-semibold text-gray-900 mb-2">Incluye:</p>
              <ul className="text-sm text-gray-700 space-y-1 mb-3">
                <li>• Museos Vaticanos + Capilla Sixtina (sin colas)</li>
                <li>• Audioguía Basílica San Pedro</li>
                <li>• Roma Pass 72h incluido</li>
                <li>• Hop-on Hop-off Bus</li>
              </ul>
              <p className="text-xs text-purple-700 bg-purple-100 rounded p-2">
                <strong>Veredicto:</strong> Cara. Solo si vas a usar TODO lo incluido. Normalmente es mejor tour guiado Vaticano (65-120€) por separado.
              </p>
            </div>
          </div>

          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <h5 className="font-semibold text-green-800 mb-2">💡 Nuestra Recomendación</h5>
            <p className="text-sm text-green-700">
              Para 3 días en Roma, te sale mejor comprar: <strong>Bono transporte 72h (18€)</strong> + 
              <strong> Entradas individuales</strong> o <strong>tours guiados</strong> según tu interés. 
              Las tarjetas turísticas solo compensan si vas a visitar MUCHOS museos en poco tiempo.
            </p>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
            ...
            ⚡ Consejos Rápidos Esenciales
          </h3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">🎟️ Reservas Imprescindibles</h5>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• <strong>Coliseo:</strong> Reservar 30 días antes (se agota rápido)</li>
                <li>• <strong>Vaticano:</strong> Reservar 60 días antes máximo</li>
                <li>• <strong>Tours guiados:</strong> Reserva online con antelación</li>
              </ul>
            </div>

            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">👗 Dress Code</h5>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• <strong>Iglesias/Vaticano:</strong> Hombros y rodillas cubiertas (obligatorio)</li>
                <li>• <strong>Llevar pañuelo:</strong> Por si necesitas cubrirte</li>
                <li>• <strong>Zapatos cómodos:</strong> Caminarás MUCHO (15-20km/día)</li>
              </ul>
            </div>

            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">💧 Agua Gratis</h5>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• <strong>Nasoni:</strong> Fuentes públicas con agua potable por toda Roma</li>
                <li>• <strong>Rellena tu botella:</strong> Ahorra dinero y es ecológico</li>
                <li>• <strong>Agua de calidad:</strong> Es la misma del grifo, totalmente segura</li>
              </ul>
            </div>

            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <h5 className="font-semibold text-gray-900 mb-2">⚠️ Seguridad</h5>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• <strong>Carteristas:</strong> Cuidado en metro y zonas turísticas</li>
                <li>• <strong>Mochila delante:</strong> En lugares concurridos</li>
                <li>• <strong>Evita zona Termini:</strong> De noche puede ser conflictiva</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {/* 3. MAPA DEL ITINERARIO (Placeholder) */}
      <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-all duration-300 mb-8">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">🗺️ Mapa del Itinerario</h2>
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
          <p className="text-gray-600 mb-2">📍 Mapa interactivo del recorrido</p>
          <p className="text-sm text-gray-500">(Aquí iría un mapa con los puntos marcados por día)</p>
        </div>
      </div>

      {/* 4. RESUMEN TABLA 3 DÍAS */}
      <div className="bg-gradient-to-r from-red-50 to-amber-50 rounded-2xl p-6 sm:p-8 mb-8 shadow-md">
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-3 mb-4">
              ...
              <p className="text-yellow-700 text-xs">
                Visitar Coliseo + Foro + Palatino lleva toda la mañana (4-5 horas mínimo). 
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-2">
              <a href="https://gyg.me/JNMNOu6o" target="_blank" rel="noopener noreferrer"
                 className="inline-flex items-center bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold px-4 py-2 rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-sm">
                🎨 Visita Guiada: Basílica, Tumbas Papales y La Piedad
                <ExternalLink className="h-3 w-3 ml-2" />
              </a>
            </div>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-all duration-300 mb-8">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">💰 Presupuesto Detallado por Estilo de Viaje</h2>
        ...
        <div className="bg-gradient-to-r from-red-50 to-amber-50 rounded-2xl p-6 sm:p-8 shadow-md mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Es segura Roma?</h4>
                <p className="text-sm text-gray-700">
                  Sí, Roma es generalmente segura. Los principales riesgos son carteristas en metro y zonas turísticas. 
                  Lleva la mochila delante en sitios concurridos y evita la zona de Termini por la noche.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Cuántos días necesito para ver Roma?</h4>
                <p className="text-sm text-gray-700">
                  Mínimo 3 días para ver lo imprescindible (Coliseo, Vaticano, centro histórico). 
                  Idealmente 4-5 días si quieres verla con más calma y hacer excursiones.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Vale la pena la Roma Pass?</h4>
                <p className="text-sm text-gray-700">
                  Generalmente NO. Es más barato comprar entradas individuales + bono transporte por separado. 
                  Solo compensa si vas a visitar MUCHOS museos en 72 horas.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Cómo evito las colas en el Coliseo y Vaticano?</h4>
                <p className="text-sm text-gray-700">
                  Reserva entradas online con antelación (30 días Coliseo, 60 días Vaticano) o contrata tours guiados 
                  que incluyen acceso sin colas. Nunca compres entradas en taquilla el mismo día.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Puedo beber agua del grifo en Roma?</h4>
                <p className="text-sm text-gray-700">
                  Sí, el agua de Roma es excelente y totalmente potable. Hay cientos de fuentes públicas (nasone) 
                  por toda la ciudad donde puedes rellenar tu botella gratis.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-1">¿Necesito hablar italiano?</h4>
                <p className="text-sm text-gray-700">
                  No es imprescindible. En zonas turísticas hablan inglés y español. Algunas palabras básicas 
                  en italiano son apreciadas: "grazie" (gracias), "per favore" (por favor), "buongiorno" (buenos días).
                </p>
              </div>
            </div>
          </div>
