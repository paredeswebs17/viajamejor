...
<div className="mb-8">
  ...
  <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
    ...
    {/* NUEVO - Tip de horario */}
    <div className="bg-white rounded-xl p-3 border border-gray-200 shadow-sm mb-4">
      <p className="text-xs text-cyan-600">
        💡 <strong>Mejor horario:</strong> El crucero de las 18:00h es perfecto: ves el atardecer sobre el río y llegas a Greenwich justo cuando se iluminan los edificios. Si solo quieres el paseo en barco, haz ida y vuelta sin bajar (1 hora).
      </p>
    </div>
