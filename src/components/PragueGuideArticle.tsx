...
src="https://images.pexels.com/photos/32795906/pexels-photo-32795906.jpeg"
  ...
  <div className="bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 border border-blue-200 rounded-2xl p-6 sm:p-8 shadow-lg mb-8">
    ...
    <p className="text-gray-600 mb-6">Prepara tu viaje con estas herramientas imprescindibles</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-5 border border-purple-200 shadow-sm">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Revolut: Tipo de cambio real sin comisiones. Ahorro garantizado: 10-20 € en 3 días vs. bancos tradicionales.
            </p>
            <a
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-5 border border-green-200 shadow-sm">
            ...
            <p className="text-sm text-gray-700 mb-4">
              IATI Estándar: Cobertura médica 200.000 € en Europa. Precio 3 días: 9-12 € Aprox. 5% descuento exclusivo.
            </p>
            <a
