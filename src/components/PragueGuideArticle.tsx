    ...
    <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
      <div className="flex items-center mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 mb-2">La ubicación más céntrica y cómoda para explorar Praga</p>
      ...
      <button
        onClick={() => toggleZone('centro-praga')}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <span className="font-bold text-lg block">
              {expandedZone === 'centro-praga' ? 'Ocultar hoteles' : 'Ver 3 hoteles recomendados'}
            </span>
            <span className="text-sm text-emerald-100 block">
              Hoteles en el centro de Praga
            </span>
          </div>
        </div>
        {expandedZone === 'centro-praga' ?
        ...
        <div className="bg-white rounded-2xl p-5 border-2 border-blue-200 flex flex-col shadow-lg hover:shadow-xl hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
            <p className="text-sm text-green-800">
              <strong>✅ Por qué elegir esta zona:</strong> El corazón de Praga, cerca del Reloj Astronómico, Puente de Carlos y la Ciudad Vieja. Todo a pie, rodeado de restaurantes, cafés y ambiente histórico. Zona segura y muy animada.
            </p>
          </div>
        </div>
      )}
    ...
    <div className="mb-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="bg-white border-l-4 border-emerald-500 rounded-lg p-4 mb-4 mt-4">
          ...
          <a href="https://www.freetour.com/es/prague/free-tour-ciudad-vieja-y-barrio-judio-reloj-astronomico?referralID=rFW5gyO0D7w7JOqo&campaign=PragaCentro"
             target="_blank"
             rel="noopener noreferrer"
             className="btn-hotel">
