        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• <strong>Inversión:</strong> 6.000 HUF (≈ 15€)</li>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• <strong>Entrada:</strong> 5.000 HUF (≈ 14€)</li>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        ...
        <div className="space-y-3">
          <div className="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <p className="text-xs text-red-600 mt-1">⚠️ Solo efectivo • Horario: 11:00-23:00</p>
          </div>
          <div className="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <a href="http://spinoza.hu/?lang=en" target="_blank" rel="noopener noreferrer"
               className="text-sky-600 hover:text-sky-800 underline text-xs">
              🌐 Reservas y menú
            </a>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• <strong>Días laborables:</strong> 5.900 HUF (≈ 16€) día completo</li>
              <li>• <strong>Fines de semana:</strong> 6.400 HUF (≈ 17€) día completo</li>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• <strong>Reservas:</strong> Solo cenas después 18:00h</li>
              <li>• <strong>Valor:</strong> Es experiencia, no solo café</li>
              <li>• <strong>Música live:</strong> Desde 11:00h</li>
            </ul>
          </div>
        </div>
        <div className="bg-white rounded-lg p-3 border border-gray-200">
    ...
    <div className="mb-6">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <ul className="text-sm text-gray-700 space-y-2">
          ...
          <li>• <strong>Cambio actual:</strong> 1€ = 395 HUF (septiembre 2025)</li>
  ...
  <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 mb-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <div className="bg-white rounded-lg p-4 border border-gray-200">
        <h3 className="font-semibold text-gray-900 mb-3">🏛️ Atracciones Principales</h3>
      ...
      <div className="bg-white rounded-lg p-4 border border-gray-200">
        <h3 className="font-semibold text-gray-900 mb-3">🍽️ Restaurantes</h3>
        <div className="space-y-2 text-sm">
          <a href="https://newyorkcafe.hu/en/" target="_blank" rel="noopener noreferrer"
             className="block text-sky-600 hover:text-sky-800 underline">
            New York Café
