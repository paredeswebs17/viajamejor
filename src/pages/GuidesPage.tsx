...
const GuidesPage = () => {
  ...
  const guides = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/1845331/pexels-photo-1845331.jpeg?auto=compress&cs=tinysrgb&w=600',
      price: '60€',
      rating: 4.8,
      continent: 'Europa',
      budget: '€€',
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/161901/vienna-schoenbrunn-palace-park-161901.jpeg?auto=compress&cs=tinysrgb&w=600',
      price: '85€',
      rating: 4.9,
      continent: 'Europa',
      budget: '€€€',
