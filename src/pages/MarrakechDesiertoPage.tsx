...
const RouteMap = () => {
  ...
  const mapDays = [
    ...
    { num:6, name:'Marrakech con guía local', places:'Koutoubia · Medina · Jemaa El Fna · Bahía', lodging:'Riad Medina · desayuno', detail:'Visita guiada: Minarete de la Koutoubia, Tumbas Saadíes, Palacio de la Bahía, Jardines de Menara y la Medina. Tarde libre para perderse por las callejuelas.', tags:['Koutoubia','Tumbas Saadíes','Palacio Bahía'], lat:31.6295, lng:-7.9811 },
    { num:7, name:'Traslado aeropuerto', places:'Desayuno · tiempo libre · ¡Hasta pronto!', lodging:'Fin del tour', detail:'Desayuno tranquilo y tiempo libre hasta el traslado al aeropuerto. Fin de los servicios. Marruecos de verdad, vivido desde dentro. ¡Hasta pronto!', tags:['Traslado aeropuerto','Fin del tour'], lat:31.5500, lng:-8.0800 },
  ];
